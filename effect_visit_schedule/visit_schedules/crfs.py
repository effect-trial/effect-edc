...
crfs_unscheduled = FormsCollection(
    ...
    Crf(show_order=40, model="effect_subject.diagnoses"),
    Crf(show_order=400, model="effect_subject.healtheconomics"),
...
crfs_d14 = FormsCollection(
    Crf(show_order=10, model="effect_subject.vitalsigns"),
    Crf(show_order=20, model="effect_subject.mentalstatus"),
    Crf(show_order=30, model="effect_subject.signsandsymptoms"),
    Crf(show_order=40, model="effect_subject.diagnoses"),
    Crf(show_order=50, model="effect_subject.arvtreatment"),
    Crf(show_order=60, model="effect_subject.patienttreatment"),
    Crf(show_order=70, model="effect_subject.patienttreatmentday14"),
    Crf(show_order=80, model="effect_subject.bloodresultsfbc"),
    Crf(show_order=90, model="effect_subject.chestxray", required=False),
    Crf(show_order=400, model="effect_subject.healtheconomics"),
    Crf(show_order=500, model="effect_subject.clinicalnote"),
