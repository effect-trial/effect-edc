...
crfs_prn = FormsCollection(
    ...
    Crf(show_order=300, model="effect_subject.tbdiagnostics"),
...
crfs_d01 = FormsCollection(
    ...
    Crf(show_order=80, model="effect_subject.chestxray"),
    Crf(show_order=100, model="effect_subject.bloodresultsfbc"),
    Crf(show_order=140, model="effect_subject.lpcsf"),
    Crf(show_order=160, model="effect_subject.tbdiagnostics"),
    Crf(show_order=400, model="effect_subject.healtheconomics"),
    Crf(show_order=500, model="effect_subject.clinicalnote"),
    name=DAY01,
)
...
crfs_d14 = FormsCollection(
    ...
    Crf(show_order=50, model="effect_subject.diagnoses"),
    Crf(show_order=60, model="effect_subject.chestxray"),
