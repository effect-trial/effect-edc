...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.TextField(blank=True, null=True, verbose_name='If NO, please specify reason ...'),
        ),
        migrations.AddField(
        ...
        migrations.AlterField(
            ...
            name='on_tb_tx',
            field=models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=5, verbose_name='Is the participant currently taking TB treatment?'),
        ),
        migrations.AlterField(
