# Generated by Django 3.2.8 on 2022-05-02 20:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('effect_subject', '0044_auto_20220502_2236'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='historicalpatienttreatment',
            name='steroids',
            field=models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Were steroids administered to the patient?'),
        ),
        migrations.AlterField(
            model_name='historicalpatienttreatment',
            name='steroids_given',
