...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='histopathology',
            options={'default_permissions': ('add', 'change', 'delete', 'view', 'export', 'import'), 'get_latest_by': 'modified', 'ordering': ('-modified', '-created'), 'verbose_name': 'Histopathoplogy', 'verbose_name_plural': 'Histopathoplogy'},
        ),
        migrations.AlterModelOptions(
            name='historicalhistopathology',
            options={'get_latest_by': 'history_date', 'ordering': ('-history_date', '-history_id'), 'verbose_name': 'historical Histopathoplogy'},
        ),
        migrations.AddField(
