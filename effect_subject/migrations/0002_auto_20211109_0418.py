    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assessment_type', models.CharField(choices=[('telephone', 'Telephone'), ('in_person', 'In person')], max_length=15, verbose_name='Was this a telephone follow up or an in person visit?')),
                ('info_source', models.CharField(choices=[('patient', 'Patient'), ('next_of_kin', 'Next of kin'), ('OTHER', 'Other')], default='patient', max_length=15, verbose_name='If by telephone, who did you speak to?')),
                ('info_source_other', edc_model.models.fields.other_charfield.OtherCharField(blank=True, max_length=35, null=True, verbose_name='If other, please specify ...')),
                ('survival_status', models.CharField(choices=[('alive_well', 'Alive and well'), ('alive_unwell', 'Alive, but unwell'), ('dead', 'Deceased')], max_length=15, verbose_name='What is the patient status?')),
                ('hospitalized', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Has the patient been hospitalized since the last assessment?')),
                ('adherence_counselling', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=15, verbose_name='Was adherence counselling given?')),
        ...
        migrations.AddIndex(
            model_name='followup',
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='effect_subj_subject_64f16e_idx'),
        ),
    ]
