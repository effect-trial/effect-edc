...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('0', '[0] No symptoms'), ('1', '[1] No significant disability. Able to carry out usual activities, despite some symptoms.'), ('2', '[2] Slight disability. Able to look after own affairs without assistance, but unable to carry out all previous activities.'), ('3', '[3] Moderate disability. Requires some help, but able to walk unassisted.'), ('4', '[4] Moderately severe disability. Unable to attend to own bodily needs without assistance, and unable to walk unassisted.'), ('5', '[5] Severe disability. Requires constant nursing care and attention, bedridden, incontinent.'), ('6', '[6] Dead'), ('not_done', 'Not done')], max_length=15, verbose_name='Modified Rankin Score'),
        ),
        migrations.AlterField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('crf_status', models.CharField(choices=[('INCOMPLETE', 'Incomplete (some data pending)'), ('COMPLETE', 'Complete')], default='COMPLETE', help_text='If some data is still pending, flag this CRF as incomplete', max_length=25, verbose_name='CRF status')),
                ('crf_status_comments', models.TextField(blank=True, help_text='for example, why some data is still pending', null=True, verbose_name='Any comments related to status of this CRF')),
                ('csf_requisition', models.ForeignKey(blank=True, help_text='Start typing the requisition identifier or select one from this visit', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='csfrequisition', to='effect_subject.subjectrequisition', verbose_name='CSF Requisition')),
                ('qc_requisition', models.ForeignKey(blank=True, help_text='Start typing the requisition identifier or select one from this visit', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='qcrequisition', to='effect_subject.subjectrequisition', verbose_name='QC Requisition')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='sites.site')),
                ('subject_visit', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='effect_subject.subjectvisit')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_change_reason', models.CharField(max_length=100, null=True)),
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('csf_requisition', models.ForeignKey(blank=True, db_constraint=False, help_text='Start typing the requisition identifier or select one from this visit', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='effect_subject.subjectrequisition', verbose_name='CSF Requisition')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('qc_requisition', models.ForeignKey(blank=True, db_constraint=False, help_text='Start typing the requisition identifier or select one from this visit', null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='effect_subject.subjectrequisition', verbose_name='QC Requisition')),
                ('site', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='sites.site')),
                ('subject_visit', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='effect_subject.subjectvisit')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='lpcsf',
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='effect_subj_subject_b9f353_idx'),
        ),
        migrations.AddIndex(
            model_name='histopathology',
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='effect_subj_subject_511a8a_idx'),
        ),
        migrations.AddIndex(
            model_name='bloodculture',
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='effect_subj_subject_404a7c_idx'),
        ),
        migrations.AddIndex(
            model_name='adherence',
            index=models.Index(fields=['subject_visit', 'site', 'id'], name='effect_subj_subject_d79350_idx'),
        ),
    ]
