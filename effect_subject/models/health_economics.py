...
from ..choices import CHILDCARE_CHOICES, PAYEE_CHOICES, TRANSPORT_CHOICES
...
class HealthEconomics(CrfModelMixin, edc_models.BaseUuidModel):
    ...
    payment_method_other_drugs_past = models.CharField(
        verbose_name="If YES, how did you pay or who paid for Antiretroviral drugs?If YES, how did you pay or "
        "who paid for Other drugs for relief?",
        max_length=45,
        choices=PAYEE_CHOICES,
        default=NOT_APPLICABLE,
    )
    ...
    spent_money_other_health_activities_past = models.CharField(
        verbose_name="Since your last study visit, did you spend money on other activities (not drugs) relating to "
        "your health?",
        max_length=15,
        choices=YES_NO,
    )
    ...
    num_day_activities_disrupted = models.IntegerField(
        verbose_name="Over the past period since your treatment, how many days were your normal activities disrupted "
        "through illness?",
    )
    ...
    someone_looking_children = models.CharField(
        verbose_name="Did you ask anyone else, such as your family member, friend to look after your child/children "
        "in order to come here?",
        max_length=15,
        choices=YES_NO,
    )
    someone_looking_children_activities = models.CharField(
        verbose_name="If YES, what would they have been doing if they had not stayed to look after your child or "
        "children?",
        max_length=45,
        choices=CHILDCARE_CHOICES,
    )
    ...
    transport_used_amount = models.IntegerField(
        verbose_name="How much will you spend on transport in total (coming to the health care facility and going "
        "back home)?",
    )
    ...
    admitted_amount_spent_other_items = models.IntegerField(
        verbose_name="While you were admitted, how much money did you spend on other items such as airtime, "
        "toiletries (soap/shampoo, toothbrush/toothpaste, bucket/basin for washing, toilet paper), "
        "clothes and cups/plates?",
    )
    ...
    admitted_people_time_off_work = models.CharField(
        verbose_name="Did a family member/friend have to take time off work to stay with you or to come see you "
