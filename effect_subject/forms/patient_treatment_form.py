...
class PatientTreatmentFormValidator(FormValidator):
    ...
    def validate_tb_tx(self):
        ...
        self.applicable_if(YES, field="tb_tx", field_applicable="tb_tx_date_estimated")
    ...
    def validate_steroids(self):
        ...
        self.applicable_if(
            YES, field="steroids", field_applicable="steroids_date_estimated"
        )
    ...
    def validate_antibiotics(self):
        ...
        self.applicable_if(
            YES, field="antibiotics", field_applicable="antibiotics_date_estimated"
        )
    ...
    def validate_other_drugs(self):
        ...
        self.applicable_if(
            YES, field="other_drugs", field_applicable="other_drugs_date_estimated"
        )
