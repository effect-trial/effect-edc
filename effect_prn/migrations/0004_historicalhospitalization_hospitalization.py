    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admitted_date', models.DateField(validators=[edc_model.models.validators.date.date_not_future, edc_protocol.validators.date_not_before_study_start], verbose_name='When was the patient admitted?')),
                ...
                ('discharged_date', models.DateField(blank=True, null=True, validators=[edc_model.models.validators.date.date_not_future, edc_protocol.validators.date_not_before_study_start], verbose_name='If YES, give date discharged')),
                ...
                ('lp_performed', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No'), ('unknown', 'Unknown')], default='N/A', max_length=15, verbose_name='Was a lumbar puncture performed during this hospitalization?')),
                ('lp_count', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(1)], verbose_name='If YES, number performed during this hospitalization')),
