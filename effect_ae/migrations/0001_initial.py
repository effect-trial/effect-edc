    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('death_location_type', models.CharField(choices=[('home', 'At home'), ('hospital_clinic', 'Hospital/clinic'), ('home', 'Elsewhere')], max_length=50, verbose_name='Where did the participant die?')),
                ('death_location_name', models.CharField(blank=True, max_length=150, null=True, verbose_name='If death occurred at hospital / clinic, please give name of the facility')),
                ('informant_contacts', django_crypto_fields.fields.encrypted_text_field.EncryptedTextField(blank=True, help_text=' (Encryption: AES local)', max_length=71, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('death_report', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='effect_ae.deathreport')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_type', models.CharField(choices=[('+', 'Created'), ('~', 'Changed'), ('-', 'Deleted')], max_length=1)),
                ('action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.actionitem')),
                ('ae_initial', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='effect_ae.aeinitial')),
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('parent_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.actionitem')),
                ('related_action_item', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_action_item.actionitem')),
                ('site', models.ForeignKey(blank=True, db_constraint=False, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='sites.site')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_action_item.actionitem')),
                ('cause_of_death', models.ForeignKey(help_text='Main cause of death in the opinion of the local study doctor and local PI', null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_adverse_event.causeofdeath', verbose_name='Main cause of death')),
                ('death_report', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='effect_ae.deathreport')),
                ('parent_action_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.actionitem')),
                ('related_action_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.actionitem')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='sites.site')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('officials_notified', models.DateTimeField(blank=True, null=True, validators=[edc_model.models.validators.date.datetime_not_future], verbose_name='Date and time regulatory authorities notified (SUSARs)')),
                ('action_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_action_item.actionitem')),
                ('ae_initial', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='effect_ae.aeinitial')),
                ('parent_action_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.actionitem')),
                ('related_action_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='edc_action_item.actionitem')),
                ('site', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='+', to='sites.site')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_datetime', models.DateTimeField(default=edc_utils.date.get_utcnow, validators=[edc_model.models.validators.date.datetime_not_future], verbose_name='Report date and time')),
                ('clinical_review_datetime', models.DateTimeField(blank=True, null=True, validators=[edc_model.models.validators.date.datetime_not_future], verbose_name='Date and time of clinical review: ')),
                ('ae_classification_other', edc_model.models.fields.other_charfield.OtherCharField(blank=True, max_length=250, null=True, verbose_name='If other, please specify ...')),
                ('ae_type', models.CharField(choices=[('sae', 'Serious Adverse Event / Reaction'), ('aesi', 'Adverse Event of Special Interest'), ('susar', 'Serious Unexpected Adverse Reaction')], max_length=25, verbose_name='Type of event')),
                ('study_drug_relation', models.CharField(choices=[('not_related', 'Not related'), ('unlikely_related', 'Unlikely related'), ('possibly_related', 'Possibly related'), ('probably_related', 'Probably related'), ('definitely_related', 'Definitely related'), ('N/A', 'Not applicable')], max_length=25, null=True, verbose_name='Relationship to study drug:')),
                ('ae_expected', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=25, null=True, verbose_name='Based on the protocol, do you believe this event is expected?')),
                ('ae_action_required', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], max_length=25, null=True, verbose_name='If unexpected, do you believe further action is required?')),
                ('investigator_comments', models.TextField(blank=True, null=True, verbose_name="This Clinical Reviewer's comments:")),
                ('original_report_agreed', models.CharField(choices=[('Yes', 'Yes'), ('No', 'No')], help_text='If No, explain in the narrative below', max_length=15, null=True, verbose_name='Does this Clinical Reviewer agree with the original AE report?')),
                ('narrative', models.TextField(blank=True, null=True, verbose_name='Narrative')),
                ('officials_notified', models.DateTimeField(blank=True, null=True, validators=[edc_model.models.validators.date.datetime_not_future], verbose_name='Date and time regulatory authorities notified')),
                ('ae_classification', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_adverse_event.aeclassification', verbose_name='Adverse Event (AE) Classification')),
                ('ae_initial', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='effect_ae.aeinitial')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            bases=('effect_ae.deathreporttmg',),
            managers=[
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='effect_ae_d_subject_f0f0f6_idx'),
        ),
        migrations.AddIndex(
            model_name='deathreport',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='effect_ae_d_subject_f0b2ac_idx'),
        ),
        migrations.AddIndex(
            model_name='aetmg',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='effect_ae_a_subject_96ad63_idx'),
        ),
        migrations.AddIndex(
            model_name='aesusar',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='effect_ae_a_subject_d55a34_idx'),
        ),
        migrations.AddIndex(
            model_name='aeinitial',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='effect_ae_a_subject_62a4d3_idx'),
        ),
        migrations.AddIndex(
            model_name='aefollowup',
            index=models.Index(fields=['subject_identifier', 'action_identifier', 'site', 'id'], name='effect_ae_a_subject_3fb419_idx'),
        ),
    ]
