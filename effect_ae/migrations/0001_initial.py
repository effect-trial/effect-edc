    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ae_initial",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.PROTECT, to="effect_ae.aeinitial"
                    ),
                ),
                (
                    "parent_action_item",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="effect_ae_d_subject_f0f0f6_idx",
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["subject_identifier", "action_identifier", "site", "id"],
                name="effect_ae_d_subject_f0b2ac_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="aetmg",
            index=models.Index(
                fields=["subject_identifier", "action_identifier", "site", "id"],
                name="effect_ae_a_subject_96ad63_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="aesusar",
            index=models.Index(
                fields=["subject_identifier", "action_identifier", "site", "id"],
                name="effect_ae_a_subject_d55a34_idx",
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["subject_identifier", "action_identifier", "site", "id"],
                name="effect_ae_a_subject_3fb419_idx",
            ),
        ),
    ]
