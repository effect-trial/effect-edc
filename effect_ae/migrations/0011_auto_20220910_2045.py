...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='edc_adverse_event.aeactionclassification', verbose_name='Classification of action taken'),
        ),
        migrations.AddField(
            model_name='historicalaeinitial',
            name='ae_action_classification',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='edc_adverse_event.aeactionclassification', verbose_name='Classification of action taken'),
        ),
